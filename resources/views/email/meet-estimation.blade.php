<html>
  <head>
    <title>Meet & Greet- Booking Estimation</title>
  ...
  <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
      ...
      <td valign="top" style="background: #FFF;padding: 0px; margin: 0px; outline: none; border: none;" width="345" height="73">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" background="#FFF">
          <tr>
            ...
            <td valign="top">
              <p style="font-family: 'Arial'; font-size: 14px; color: #5f6062; line-height: 25px; margin: 0px; text-align: right;">{{$meet->updated_at}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
    ...
    <tr>
      ...
      <td valign="top" style="background:#FFF;" width="345" height="171">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" background="#FFF">
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Meet & Greet Service</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->meet_service}}</p>
            </td>
          </tr>           
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Flight Number</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->flight_number}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->company}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Date of Travel</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->date}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Time of Travel</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->time}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->luggage}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->travelers}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Booking reference</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->booking_reference}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Option product</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->product}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Connection flight: Departure time from OSL</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->departure_time}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Connection flight: Flight number </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->connect_flight_number}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Request NO </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->id}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->contact_person}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->email}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$meet->phone}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
          ...
          <tr>
            <td valign="top" colspan="2">
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 28px; margin: 0px; text-align: left;">{{$meet->comments}}</p>
            </td>
          </tr>  
        </table>
      </td>
    ...
    <tr>
      ...
      <td valign="top" width="345" height="111" style="text-align: center; background: #FFF;padding: 0px; margin: 0px; outline: none; border: none;">
        <p style="font-family: 'Arial'; font-size: 12px; color: #5f6062; line-height: 16px; margin: 0px;">
          <span style="color: #c29734;">Hello {{$meet->contact_person}}, </span>
      ...
      <td valign="top" style="background: #FFF;padding: 0px; margin: 0px; outline: none; border: none;">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" background="#FFF">
          <tr>
            ...
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial';font-size: 18px; color: #c29734; line-height: 16px; margin: 10px 0px 0px 0px; text-align: right;">{{$meet->total_cost}}€</p>
            </td>
          </tr>                    
        </table>
      </td>
    ...
    <tr>
      <td valign="top">
        <img style="display:block; margin:0px; padding:0px; outline:none; border:none;" src="https://accessoslo.fantasylab.io/assets/images/template2_26.jpg" width="76" height="29" alt=""></td>
      <td valign="top">
        <img style="display:block; margin:0px; padding:0px; outline:none; border:none;" src="https://accessoslo.fantasylab.io/assets/images/template2_27.jpg" width="345" height="29" alt=""></td>
      <td valign="top">
        <img style="display:block; margin:0px; padding:0px; outline:none; border:none;" src="https://accessoslo.fantasylab.io/assets/images/template2_28.jpg" width="79" height="29" alt=""></td>
    </tr>
    <tr>
      <td valign="top">
