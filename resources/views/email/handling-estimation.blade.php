<html>
  ...
  <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td valign="top">
        <img style="display:block; margin:0px; padding:0px; outline:none; border:none;" src="https://accessoslo.fantasylab.io/assets/images/template2_08.jpg" width="76" height="620" alt=""></td>
      <td valign="top" style="background:#FFF;" width="345" height="171">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" background="#FFF">
          ...
          <tr>
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->phone}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
      ...
      <td valign="top">
        <img style="display:block; margin:0px; padding:0px; outline:none; border:none;" src="https://accessoslo.fantasylab.io/assets/images/template2_10.jpg" width="79" height="620" alt=""></td>
    </tr>
    <tr>
      <td valign="top">
