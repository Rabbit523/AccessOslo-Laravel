      ...
      <td valign="top" style="background: #FFF;padding: 0px; margin: 0px; outline: none; border: none;" width="345" height="73">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" background="#FFF">
          <tr>
            ...
            <td valign="top">
              <p style="font-family: 'Arial'; font-size: 14px; color: #5f6062; line-height: 25px; margin: 0px; text-align: right;">{{$handling->updated_at}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
      ...
      <td valign="top" style="background:#FFF;" width="345" height="171">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" background="#FFF"> 
          ...
          <tr>
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->airport}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Company name</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->company}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Aircraft</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->aircraft}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Crew Config1</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->crew_config1}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Crew Config2</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->crew_config2}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Flight Type</p>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->hotac}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Catering</p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->catering}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
          ...
          <tr>
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->email}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Inbound Flight </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->inbound_flight}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Inbound Date </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->inbound_date}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Inbound Orig </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->inbound_orig}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Inbound Captain </p>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->inbound_pax}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Outbound Flight </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->outbound_flight}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Outbound Date </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->outbound_date}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Outbound Orig </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->outbound_orig}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Outbound Captain </p>
            </td>
            <td>
              <p style="font-family: 'Arial'; font-size: 12px; color: #afafaf; line-height: 22px; margin: 0px; text-align: right;">{{$handling->outbound_captain}}</p>
            </td>
          </tr>
          <tr>
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial'; font-size: 12px; color: #c59d3d; line-height: 22px; margin: 0px;">Outbound UTC </p>
            </td>
            <td>
    ...
    <tr>
      ...
      <td valign="top" width="345" height="111" style="text-align: center; background: #FFF;padding: 0px; margin: 0px; outline: none; border: none;">
        <p style="font-family: 'Arial'; font-size: 12px; color: #5f6062; line-height: 16px; margin: 0px;">
          <span style="color: #c29734;">Hello {{$handling->person}}, </span>
          <br>Thank you for your handling request. Our team will get in touch shortly. </p>
      </td>
      <td valign="top">
      ...
      <td valign="top" style="background: #FFF;padding: 0px; margin: 0px; outline: none; border: none;">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" background="#FFF">
          <tr>
            ...
            <td valign="top" style="background: #fff;">
              <p style="font-family: 'Arial';font-size: 18px; color: #c29734; line-height: 16px; margin: 10px 0px 0px 0px; text-align: right;">{{$handling->total_cost}}€</p>
            </td>
          </tr>                    
        </table>
      </td>
