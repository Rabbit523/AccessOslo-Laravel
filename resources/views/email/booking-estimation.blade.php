<html>
  ...
  <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td valign="top" style="background:#FFF;">
        <form id="payment_form" method="POST" action="{{ URL::to('services/paypal') }}">
          {{ csrf_field() }}
          <input type="hidden" value="{{$booking_charter->total_cost}}">
          <input type="submit" style="background: #c29734; color: #FFF; text-transform: uppercase; font-family: 'Arial'; font-size: 11px; font-weight: bold;display: block; margin: 5px auto 0px; width: 95%; text-align: center; padding: 10px 0px; text-decoration: none;" value="Confirm & Pay">
        </form>
      </td>
      <td valign="top">
