...
<div class="page-container">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="title-box">
                        <h1>{{$title}}</h1>    
                        <a class="btn btn-gray new_page">New Page</a>                            
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="info-user">
    ...
    <div class="page-content accessoslo-pages">
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    ...
                    <div class="content-box">
                        ...
                        <div class="items-list">                            
                            ...
                            <div class="item">
                                <div class="row">
                                    <div class="label-table title">{{$data->page_title_plain}} <a class="edit" data-id="{{$data->id}}">Edit</a> <a class="delete" data-id="{{$data->id}}">Delete</a></div>
...
<script>jQuery(function(){new Accessoslo.Controllers.AdminPages();});</script>
@endsection