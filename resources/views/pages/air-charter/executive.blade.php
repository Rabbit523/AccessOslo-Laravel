            ...
            <div class="container">
                <div class="row wrapper-box">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <div class="aux-img">
                        <img src="/assets/img/executive-second-banner2.jpg" class="img-responsive center-block" style="margin-top: 30px; box-shadow: 0px 0px 15px 0px rgba(61, 47, 12, 0.15);">
                        </div>
                    </div>
                </div>
            </div>
