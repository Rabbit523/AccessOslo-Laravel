...
(function($, window) {
  ...
  'background-size': 'cover'
    ...
    _createArrow: function(elem, list) {
      ...
      var leftArrow = $('<a class="arrow-left"><i class="fa fa-angle-left" aria-hidden="true"></i><a/>', {
        class: this.options.arrowLeftClass
      });

      var rightArrow = $('<a class="arrow-right"><i class="fa fa-angle-right" aria-hidden="true"></i><a/>', {
