...
var accessosloPrivatetravel = angular.module('accessosloApp.accessosloPrivatetravel', []);
var accessosloApp = angular.module('accessosloApp', ['accessosloApp.application', 'accessosloApp.accessosloPrivatetravel']);
...
'use strict';
accessosloPrivatetravel.directive('accessosloPrivatetravel', ["accessosloAPI", function (accessosloAPI) {
  return {
    templateUrl: '/ng/directives/private-travel/view.html',
    scope: {},
