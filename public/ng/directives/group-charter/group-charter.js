...
var accessosloGroupcharter = angular.module('accessosloApp.accessosloGroupcharter', []);
var accessosloApp = angular.module('accessosloApp', ['accessosloApp.application', 'accessosloApp.accessosloGroupcharter']);
...
'use strict';
accessosloGroupcharter.directive('accessosloGroupcharter', ["accessosloAPI", function (accessosloAPI) {
  return {
    templateUrl: '/ng/directives/group-charter/view.html',
    scope: {},
